...
(function() {
  ...
  getDay = function(d) {
    return new Date(new Date(d.setHours(d.getDate() - 1)).setHours(0, 0, 0, 0));
  };
        ...
        while (num !== length) {
          for (i = l = 0, len1 = ary.length; l < len1; i = ++l) {
            ...
            if (point[0] === series.data[num].x) {
              console.log("Updating point at " + point[0] + " on " + reverse_key);
        ...
        results.push((function() {
          ...
          for (i = m = 0, len2 = ary.length; m < len2; i = ++m) {
            ...
            if (point[0] > series.data[length - 1].x) {
              console.log("Adding point at " + point[0] + " to " + reverse_key);
  ...
  $(function() {
    ...
    return (requestData = function() {
      ...
      if (typeof min_req !== "undefined" && min_req !== null) {
        ...
        setTimeout(requestAltData, 3600000);
      }
