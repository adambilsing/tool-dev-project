...
(function() {
  var buildChart, getHour, getSunday, requestAltData, stringifyKey, updateChart;
  ...
  updateChart = function(index, data) {
    var ary, i, j, l, len, len1, len2, length, m, num, point, ref, reverse_key, series;
    ...
    return Highcharts.chart[index].redraw();
  };
